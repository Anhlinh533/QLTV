...
(
	...
	IDLoaiDG varchar(5) FOREIGN KEY REFERENCES LOAIDOCGIA(IDLoaiDG),
...
(
	IDLoaiDG varchar(5) PRIMARY KEY NOT NULL,
...
CREATE TABLE TACGIA
(
	IDTacGia varchar(5) PRIMARY KEY NOT NULL,
...
(
	...
	IDDocGia varchar(5) FOREIGN KEY REFERENCES THEDOCGIA(IDDocGia),
...
(
	...
	IDBCMuonSach varchar(5) FOREIGN KEY REFERENCES BCTINHHINHMUONSACH(IDBCMuonSach),
	IDLoaiSach varchar(5) FOREIGN KEY REFERENCES LOAISACH(IDLoaiSach),
...
AS
BEGIN
	DECLARE @NGAYSINHDG datetime, @NGAYLAPTHE datetime
	
	SELECT @NGAYSINHDG = NgaySinhDG, @NGAYLAPTHE = NgayLapThe
	FROM INSERTED

	IF(DATEDIFF(year, @NGAYSINHDG, @NGAYLAPTHE) < 18 OR DATEDIFF(year, @NGAYSINHDG,  @NGAYLAPTHE) > 55)
	BEGIN
